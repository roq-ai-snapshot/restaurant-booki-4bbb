  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine v2 - Streamlining Your Dining Experience and Simplifying Restaurant Management with One Click."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine v2 - Streamlining Your Dining Experience and Simplifying Restaurant Management with One Click.`}
            </Text>
            <Box
